...
public abstract class AbstractAuthorDAOTest extends AbstractIdDAOTest<BigInteger,AuthorDTOImpl,AuthorDAO> {
	...
	public void testFindByNameNull(){
		List<AuthorDTOImpl> authorDTOImpls=new ArrayList<AuthorDTOImpl>(getDAO().findByName(null));
	...
	public void testFindByNameEmpty(){
		List<AuthorDTOImpl> authorDTOImpls=new ArrayList<AuthorDTOImpl>(getDAO().findByName(""));
		assertNotNull("The list of AuthorDTO should not be null when nothing is found",authorDTOImpls);
		assertEquals("The list of AuthorDTO should not be empty when nothing is found",0,authorDTOImpls.size());
	}
	...
	public void testFindByName(){
		List<AuthorDTOImpl> authorDTOImpls=new ArrayList<AuthorDTOImpl>(getDAO().findByName(getDTO().getName()));
		...
		authorDTOImpls=new ArrayList<AuthorDTOImpl>(getDAO().findByName(getDTO().getName()));
